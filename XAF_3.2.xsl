...
<!-- XSL voor het converteren van een XAF Auditfile Financieel versie 3.2 naar een HTML pagina voor weergave in de browser -->
  ...
  <body>
    ...
    <table class="sortable" id="taxonomy">
      ...
      <xsl:for-each select="xaf:auditfile/xaf:company/xaf:generalLedger/xaf:ledgerAccount/xaf:taxonomy">
        <tr>
          ...
          <td><xsl:value-of select="xaf:taxoRef/xaf:entryPoint[1]/xaf:entryPointRef"/></td>
          <td><xsl:value-of select="xaf:taxoRef/xaf:entryPoint[1]/xaf:conceptRef"/></td>
          <td><xsl:value-of select="xaf:taxoRef/xaf:entryPoint[1]/xaf:domainMember[1]/xaf:domainMemberRef"/></td>
        </tr>
      </xsl:for-each>
      </tbody>
    </table>
    ...
    <table class="sortable" id="trLine">
      ...
      <tr>
        ...
        <td><xsl:value-of select="xaf:receivingDocRef"/></td>
        <td><xsl:value-of select="xaf:shipDocRef"/></td>
        ...
        <td><xsl:value-of select="xaf:workCostArrRef"/></td>
        <td><xsl:value-of select="xaf:qntityID"/></td>
        <td><xsl:value-of select="xaf:qntity"/></td>

        <td><xsl:value-of select="xaf:bankAccNr"/></td>
        <td><xsl:value-of select="xaf:bankIdCd"/></td>
